...
public class MainActivity extends AppCompatActivity {
    ...
    private TextView mSearchResultsTextView,errormssj;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        errormssj=(TextView)findViewById(R.id.tv_error_message_display);
