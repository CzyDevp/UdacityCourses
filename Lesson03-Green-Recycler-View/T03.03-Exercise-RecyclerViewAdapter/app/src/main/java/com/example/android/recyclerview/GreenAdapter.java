...
import static com.example.android.recyclerview.GreenAdapter.NumberViewHolder.bind;
...
public class GreenAdapter  extends RecyclerView.Adapter<GreenAdapter.NumberViewHolder>{
    ...
    GreenAdapter(int numberOfItems)
    {
        ...
        this.mNuberItems = numberOfItems;
    }
    ...
    public NumberViewHolder onCreateViewHolder(ViewGroup parent, int viewType)
    {
        ...
        boolean shouldAttachParentImmmediately = false;
        View view= inflater.inflate(layoutForlistItem,parent,shouldAttachParentImmmediately);
    ...
    static class NumberViewHolder extends RecyclerView.ViewHolder {
       ...
       public static TextView listItemNumberView;
         ...
         */
        public static void bind(int listIndex)
        {
